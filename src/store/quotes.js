  ...
  const allQuotes = () => ({
    ...
    allFetchedQuotes: [
      ...
      },
      {
        id: 12,
        content:
          "I sense something. A presence I have not felt since…. (A New Hope) - Darth Vader",
        faction: 1,
      },
      {
        id: 42,
      ...
      },
      {
        id: 4,
        content:
          "To die for one’s people is a great sacrifice. To live for one’s people, an even greater sacrifice. I choose to live for my people. — Riyo Chuchi (Season One, Episode 15, Trespass)",
        faction: 4,
      },
      {
        id: 41,
